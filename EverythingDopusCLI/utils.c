...
TCHAR* DopusPrepareCollection(LPTSTR dopusPath, TCHAR* collectionFilepath)
{
	...
	_sntprintf_s(commandLine, EDC_PROCESS_COMMAND_LINE_MAX_SIZE, EDC_PROCESS_COMMAND_LINE_MAX_SIZE, TEXT("\"%s\" /col import /clear /create /nocheck Everything \"%s\""), dopusPath, collectionFilepath);
	return commandLine;
}
